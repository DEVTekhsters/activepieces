...
RUN for piece in microsoft-teams smtp open-router webhook http whatsapp whatsable; do \
...
ENV AP_DEV_PIECES="microsoft-teams,smtp,open-router,webhook,http,whatsapp,whatsable"
